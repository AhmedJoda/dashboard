<div class="flex space-x-1 justify-around">
    ...
    <a href="{{ route("$route.show", [$id]) }}" target="_blank"
    ...
    <a href="{{ route("$route.edit", [$id]) }}" target="_blank"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteLabel">حذف</h5>
                ...
                <div class="modal-footer">
                    ...
                    <!-- <button wire:click="delete({{ $id }})" type="button" class="btn btn-danger" data-dismiss="modal">حذف</button> -->
